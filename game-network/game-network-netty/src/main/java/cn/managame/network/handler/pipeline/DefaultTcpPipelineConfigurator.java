...
public class DefaultTcpPipelineConfigurator implements IPipelineConfigurator {

    private final IConnectionHandler connectionHandler;
    private final ConnectionManager connectionManager;
    private final IConnectionIdGenerator connectionIdGenerator;

    public DefaultTcpPipelineConfigurator(IConnectionHandler connectionHandler,
