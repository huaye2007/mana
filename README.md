...
| `game-config` | Immutable configuration snapshots with local, Nacos, and Etcd backends, properties/YAML/JSON documents, typed reads, and change listeners (see [game-config/README.md](game-config/README.md)) |
