...
import cn.managame.runtime.event.EventMeta;
import cn.managame.runtime.event.IGameEvent;

/**
 * 单个事件监听者的派发任务。当监听者无法在发布线程内联执行（异组或异 routerKey）时，
 * {@link cn.managame.runtime.event.EventBus} 按事件 routerKey 把"调用这一个监听者"封装成本
