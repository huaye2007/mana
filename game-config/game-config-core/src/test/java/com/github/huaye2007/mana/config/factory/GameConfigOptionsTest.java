package com.github.huaye2007.mana.config.factory;
...
class GameConfigOptionsTest {
    ...
    void shouldAddValidatorsInBulkAndIgnoreNulls() {
        ...
        options.addValidators((Iterable<com.github.huaye2007.mana.config.api.ConfigValidator>) null);
    ...
    void shouldReturnValidatorListCopy() {
        ...
        List<com.github.huaye2007.mana.config.api.ConfigValidator> returned = options.getValidators();
        returned.clear();
