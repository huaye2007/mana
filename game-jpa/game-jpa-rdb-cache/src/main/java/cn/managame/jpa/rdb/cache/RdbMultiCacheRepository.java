...
import cn.managame.jpa.cache.IMultiCacheRepository;
...
public class RdbMultiCacheRepository<T, ID> implements IRdbMultiCacheRepository<T, ID> {
    ...
    public RdbMultiCacheRepository(ComponentRegistry registry,
                                    ...
                                    CacheConfig config,
                                    cn.managame.jpa.core.write.WriteTaskSubmitter writeSubmitter) {
    ...
    public RdbMultiCacheRepository(ComponentRegistry registry,
        ...
        java.util.function.Function<CacheCompositeKey, List<T>> dbLoader = compositeKey -> {
            cn.managame.jpa.rdb.query.RdbQuerySpec spec = new cn.managame.jpa.rdb.query.RdbQuerySpec();
