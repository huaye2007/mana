...
import com.github.huaye2007.mana.jpa.async.FlushThreadMode;
...
import com.github.huaye2007.mana.jpa.core.exception.ConfigurationException;
import com.github.huaye2007.mana.jpa.core.registry.DataSourceCatalog;
...
import com.github.huaye2007.mana.jpa.core.write.WriteRouter;
...
public class GameJpaContextTest {
    ...
    public void closeRejectsLaterAsyncWrites() {
        ...
        try {
            queue.submit("player", com.github.huaye2007.mana.jpa.core.write.WriteTaskSubmitter.Op.UPDATE, new Object(), 1L);
    ...
    public void closeStopsSubmissionsBeforeSchedulerFinalFlush() {
        ...
        queue.submit("player", com.github.huaye2007.mana.jpa.core.write.WriteTaskSubmitter.Op.UPDATE, "v1", 1L);
    ...
    public void bootstrapAppliesFlushBatchSize() {
        ...
        try {
            ...
            context.writeQueue().submit("player", com.github.huaye2007.mana.jpa.core.write.WriteTaskSubmitter.Op.UPDATE, "v1", 1L);
            context.writeQueue().submit("player", com.github.huaye2007.mana.jpa.core.write.WriteTaskSubmitter.Op.UPDATE, "v2", 2L);
    ...
    private record StringFactory(String value, int priority) implements RepositoryFactory {
        ...
        @Override
        public Object createRepository(Class<?> repositoryType, com.github.huaye2007.mana.jpa.core.context.ComponentRegistry registry) {
            return value;
        }
    }
    ...
    private static class RejectingFlushScheduler extends FlushScheduler {
        ...
        public void close() {
            try {
                queue.submit("player", com.github.huaye2007.mana.jpa.core.write.WriteTaskSubmitter.Op.UPDATE, "late", 2L);
            } catch (RejectedExecutionException expected) {
