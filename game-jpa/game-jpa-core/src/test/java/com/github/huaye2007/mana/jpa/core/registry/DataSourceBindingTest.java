...
public class DataSourceBindingTest {
    ...
    public void longestPackagePrefixWins() {
        DataSourceBinding binding = new DataSourceBinding();
        binding.registerPackage("com.github.huaye2007.mana.jpa", "jpa");
        binding.registerPackage("com.github.huaye2007.mana.jpa.core", "core");
        // 本测试类在 com.github.huaye2007.mana.jpa.core.registry，最长前缀命中 "com.github.huaye2007.mana.jpa.core"
